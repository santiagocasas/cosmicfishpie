...
get_ipython().run_cell_magic('timeit', '', "loglike(samp1dic, leg_flag='wedges', cosmoFM_theory=cosmoFM_theory, cosmoFM_data=cosmoFM_data, data_obsPgg=obsPgg_data)\n")


get_ipython().run_cell_magic('timeit', '', 'with warnings.catch_warnings():\n    warnings.filterwarnings("ignore")\n    loglike(samp1dic, leg_flag=\'legendre\', cosmoFM_theory=cosmoFM_theory, cosmoFM_data=cosmoFM_data, data_obsPgg=obsPgg_data)\n')
...
euclid_sp_nonui = fco.make_triangle_plot(
    ...
    chain_labels=[
        'Euclid MCMC GCsp no-nui symb',
        'Euclid MCMC GCsp no-nui symb vs camb'
        ],
    fisher_labels=[
