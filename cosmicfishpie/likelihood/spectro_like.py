...
def observable_Pgg(theory_spectro,
    ...
    for ii in range(n_bins):
        obs_Pgg[ii, :, :] = (theory_spectro.noisy_P_ij(z_bins[ii], 
                                                      cosmoFM.Pk_kmesh, 
                                                      cosmoFM.Pk_mumesh, 
                                                      si=si, sj=sj)
                                                      + nuisance_shot[ii])
...
def compute_chi2_legendre(P_ell_data, P_ell_theory, inv_covariance):
    ...
    chi2 = np.sum((P_ell_data[...,None] - P_ell_theory[...,None]) * 
                  inv_covariance * 
