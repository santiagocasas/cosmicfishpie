...
def reshuffle( fisher_matrix, names, update_names=True):
    """
...
def marginalise( fisher_matrix, names , update_names=True):
    """
    ...
    # create the new Fisher matrix:
    fisher_new = fm.fisher_matrix(fisher_matrix=fisher_temp, param_names=names, param_names_latex=new_param_names_latex, 
                                  fiducial=new_param_fiducial, name=fisher_matrix.name)
    if update_names:
